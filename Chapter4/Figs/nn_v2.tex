...
\begin{tikzpicture}[shorten >=1pt,->,draw=black!20, node distance=\layersep]
    ...
    % Annotations
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \node[annot] (x) at (7.3, -0 * \layersep) {$x \in\mathbb{R}^d$};
    \node[annot] (x) at (7.3, -1 * \layersep) {$\sigma(\vw_1 x) \in \Reals^{M}$};
    \node[annot] (x) at (7.3, -2 * \layersep) {$h_1 = \vv_1^\top \sigma(\vw_1 x) \in \Reals^{d_{1}}$};
    \node[annot] (x) at (7.3, -3 * \layersep) {$\sigma(\vw_2 h_1) \in \Reals^M$};
    \node[annot] (x) at (7.3, -4 * \layersep) {$h_2 = \vv_2^\top \sigma(\vw_2 h_1) \in \Reals^{d_{2}}$};
    \node[annot] (x) at (7.3, -5 * \layersep) {$\sigma(\vw_3 h_2) \in \Reals^M$};
    \node[annot] (x) at (7.3, -6 * \layersep) {$y = \vv_3^\top \sigma(\vw_3 h_2) \in \Reals$};
